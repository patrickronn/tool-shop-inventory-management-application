...
/**
 * Represents the Customer Management GUI for interfacing with the user. Contains user code for
...
public class CustomerManagementGUI {
    ...
    public void clearSearchResults() {
        ((DefaultListModel<String>) searchResultsList.getModel()).clear();
        ((DefaultListModel<String>) searchResultsList.getModel()).addElement(NEW_CUSTOMER_STRING);
    }
    ...
    public void addSearchResult(String searchResult) {
        ((DefaultListModel<String>) searchResultsList.getModel()).addElement(searchResult);
    }
