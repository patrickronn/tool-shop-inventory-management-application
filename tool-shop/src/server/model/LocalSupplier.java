...
public class LocalSupplier extends Supplier {
     ...
     */
    public LocalSupplier(int id, String companyName, String address, String phoneNum, String salesContact) {
        super(id, companyName, address, salesContact, phoneNum, "Local");
    }
}
